...
# Replace this URL with the direct link to the image
...
if response.status_code == 200:
    ...
    st.sidebar.error("Failed to load image. Please check the URL.")
...
with st.sidebar:
    show_tab = st.radio("Menu", ["Home", "Extract & Transform", "View"])
...
elif show_tab=="Extract & Transform":
